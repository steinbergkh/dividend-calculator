...
angular.module('dividendCalculatorApp').controller('DividendCalculatorController', function ($scope, $http, InvestYear) {
    $scope.settings = {
        yearsInvest: 20,
        initialInvestment: 1400000,
        initialDividendPayment: 3.25,
        dividendGrowthPerYear: 0.07,
        initialStockPrice: 100,
        stockPriceGrowthPerYear: 0.035,
        yearsReinvest: 10
    };
    ...
    var stockRate = $scope.settings.stockPriceGrowthPerYear;
    var dividendRate = $scope.settings.dividendGrowthPerYear;
    ...
    var setInitialVals = function setVals(){
        ...
        stockRate = $scope.settings.stockPriceGrowthPerYear;
        dividendRate = $scope.settings.dividendGrowthPerYear;
